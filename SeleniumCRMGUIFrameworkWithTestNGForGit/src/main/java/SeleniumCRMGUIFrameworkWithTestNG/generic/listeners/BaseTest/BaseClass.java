package SeleniumCRMGUIFrameworkWithTestNG.generic.listeners.BaseTest;
...
public class BaseClass {
	/* Create Object and declare it as public(Access-Specifier) because they are available in different packages*/
	 ...
	 // static variables has only one instance which isn't possible to use in parallel execution
	 // To avoid that we will create another driver variable
	@BeforeSuite
